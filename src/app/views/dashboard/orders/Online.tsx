...
export default function Online() {
  ...
  const columns: ColumnsType<IOrderList> = [
    ...
    },
    {
      ...
      width: '280px',
      render: (mobile_customer) => (
        <SkeletonTableCell loading={loading} value={mobile_customer?.full_name} />
      ),
      sorter: (a, b) =>
        a?.mobile_customer
          ? a?.mobile_customer?.full_name?.localeCompare(b?.mobile_customer?.full_name || '')
          : 0,
      sortDirections: ['descend', 'ascend'],
    },
    {
